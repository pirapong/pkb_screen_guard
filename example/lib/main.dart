...
class _GuardHomePageState extends State<GuardHomePage> {
  ...
  // ✅ เพิ่มใหม่: ปุ่มสั่งตรวจ A11Y ด้วยมือ
  Future<void> _checkA11yManual() async {
    final aas = await PkbScreenGuard.checkAccessibilityServices(
      allowedInstallers: [
        'com.android.vending',
        'com.android.packageinstaller',
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ✅ ปุ่ม A11Y (เพิ่มอย่างเดียว)
          ElevatedButton(
            onPressed: _checkA11yManual,
            child: const Text("Check Accessibility (A11Y)"),
          ),
          ...
          if (_remoteStatus != null)
            Card(
              child: ListTile(
                ...
                title: Text(
                  _remoteStatus!['remoteActive'] == true
                      ? "⚠ ตรวจพบความเป็นไปได้ว่ากำลัง Remote"
                      : "✔ ไม่พบการ Remote",
                ),
                subtitle: Text(_remoteStatus.toString()),
              ),
