...
class PkbScreenGuard {
  ...
  // ---------------------------------------------------------------------------
  // New API: manual Accessibility scan (button-triggered)
  // ---------------------------------------------------------------------------

  static Future<PkbAasStatus> scanAccessibilityNow() async {
    final result =
        await _method.invokeMethod<Map<dynamic, dynamic>>(
          'scanAccessibilityNow',
        ) ??
            <dynamic, dynamic>{};
  ...
  // ---------------------------------------------------------------------------
  // Existing API: Remote / AnyDesk detection
  // ---------------------------------------------------------------------------
